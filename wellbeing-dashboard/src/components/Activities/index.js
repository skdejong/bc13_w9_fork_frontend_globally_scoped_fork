...
export default function Activities() {
   ...
   * Each object in each list contains an ID, text, and its relevent category name.
   ...
   * initialising them with the arrays above.
   */
  ...
  /**
   * This is an array of category objects which contains information
   * about each category. Each contains an id, name, category and the state/list
   ...
   * It is initialised at 0 and will take the value of the length of the current list
   * as we map through each category.
   */
  let progressValue = 0;

  /**
   * Here we are rendering the four activity sections by mapping through the
   * categories array, and inside each category, mapping through the corresponding list.
   */
  return (
